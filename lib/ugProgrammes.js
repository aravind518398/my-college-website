...
function normalizeProgramme(programme, index) {
  ...
  return {
    ...
    shortName,
    title,
    program: String(programme.program || "").trim() || `${shortName} Honours`,
    specialisation: String(programme.specialisation || "").trim() || focus,
    ...
    highlights: cleanList(programme.highlights),
