...
export default async function AdminLoginPage() {
  ...
  return (
    <main className="h-screen overflow-y-hidden  bg-[linear-gradient(135deg,#eef7fb_0%,#f4fcfa_48%,#f8fbff_100%)]">
      <div className="mx-auto flex  max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8 lg:py-6">
        ...
        <div className="max-w-7xl mx-auto py-8 lg:py-4">
              <div className="w-full rounded-[32px] border border-[#1ab69d50] bg-white/92 p-6 shadow-2xl shadow-[#179BD7]/10 backdrop-blur sm:p-8 lg:p-10">
                <div className="mb-8">
