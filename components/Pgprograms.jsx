...
export default function PGProgramme() {
  ...
  return (
    <section className="scroll-mt-[70px] bg-white px-4 py-14 sm:px-6 lg:scroll-mt-24 lg:py-20" id="pg-programme-details">
              ...
              <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
                <Stat label="Duration" value={
                  activeProgramme.duration
                    ? `${activeProgramme.duration} ${activeProgramme.duration > 1 ? "years" : "year"
                    }`
                    : ""
                } />
