...
export default function FooterClient({ initialSettings }) {
  const settings = initialSettings || defaultSiteSettings;

  // Clean empty links using dynamic trimming checks
  const socialLinks = [
          ...
          <div className="rounded-2xl bg-white/[0.06] p-5 ring-1 ring-white/10 backdrop-blur sm:p-7">
            <Link href="#" className="inline-flex items-center gap-4">
              <span className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-white p-2 shadow-xl">
                <Image src={settings.images?.footerLogo || "/images/kmm-logo.png"} width={84} height={84} alt="KMM College logo" className="h-full w-full object-contain" />
              </span>
              <span>
